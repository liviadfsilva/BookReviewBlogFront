...
const MusingsPosts = () => {
  return (
    <div>
      <h2 className="text-[#54473F] uppercase italic text-5xl text-center font-serif mt-10 mb-12">Random Musings</h2>
      ...
      <div className="mt-36 flex justify-center mb-6">
        <button className="bg-[#e7cbb6] p-4 py-4 px-8 rounded text-[#54473F] font-semibold text-xl"><Link to="/book-reviews">More Posts</Link></button>
      </div>
    </div>
  );
};
