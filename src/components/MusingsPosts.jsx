    ...
    <div>
      ...
      <div className="flex justify-center gap-16 mt-8">
        <div className="w-[350px] h-[350px]">
          ...
          <h2 className="text-[#AF8260] italic text-2xl font-serif mt-4"><Link to="/blog/post/1">The Lore Behind the Crow</Link></h2>
        ...
        <div className="w-[350px] h-[350px]">
          ...
          <h2 className="text-[#AF8260] italic text-2xl font-serif mt-4"><Link to="/blog/post/1">Inside the Mind of a Cat</Link></h2>
        ...
        <div className="w-[350px] h-[350px]">
          ...
          <h2 className="text-[#AF8260] italic text-2xl font-serif mt-4"><Link to="/blog/post/1">The Best Brownie Recipe</Link></h2>
